...
def gen_clusters_specific(n, num_clusters):
    """Generates N points divided among num_clusters Gaussian blobs."""
...
def gen_pareto(n):
    """9. Pareto: Extreme outlier test. Spread out significantly."""
...
def gen_onion(n):
    """18. The Onion: Many concentric circles."""
